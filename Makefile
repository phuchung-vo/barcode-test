...
ensure_flutter_version: ## Ensures flutter version is 3.16.3 
	fvm install 3.16.3
	fvm use 3.16.3
	fvm global 3.16.3

## Note: If you are using a specific flutter version, change '3.16.3' to the desired '{flutter version}' you want to use
